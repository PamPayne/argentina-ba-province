...
description: This document sets out the business requirements, scope, impacted teams, and product requirements for introducing QuickFire gaming content into the regulated market of Argentina (Buenos Aires Province).
---
...
| Build & Configure MPV |  |
| Flash Core | X |
| Integrations Support Casino DB |  |
| Web Tech |  |
| Casino Config |  |
| Land Based |  |
| White Box Testing |  |
