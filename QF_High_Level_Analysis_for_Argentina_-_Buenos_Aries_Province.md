---
country: Argentina
document_name: High Level Analysis for Argentina (Buenos Aries Province)
...
Detailed Business Release Documents and Operator guidelines will be prepared for that purpose in due course.

## Registration

Operators would need to provide a compliant registration solution.

Multiple accounts per player are not allowed.

Players must be > 18 years.

To complete the user registration process, the player must agree to the T&Cs of the operator's policy which must be recorded by the operator's platform.
...
Game rules must be provided in Spanish. There is no mention of the language required for games itself. We can assume that English only, semi translated and fully translated games in Spanish may be allowed. We need to confirm with the regulator.
...
License holders shall allow players to have access to any information related to the gaming account balance, gaming history, deposits and withdrawals, as well as other related transactions.
...
Games rules must be made available to the player on the operator’s website.
...
The screen must show the participant’s current balance in legal Argentine tender, as well as the unitary and total bets made.

The interface must clearly indicate if the prizes are shown in legal Argentine tender or in credits. Different representations that may confuse the participant must not be alternated.

If random prizes associated with a play or bet are offered, the participant must know the maximum amount that can be obtained from the bet or play that they will complete.

The participant must be informed when the amount of the random prize is determined based on the amount of the play or bet. When the text or graphic elements announce a maximum prize, it must be possible to achieve this prize through a single game.

## Free Games

Free games and Bonuses are allowed but the regulator can impose limits.

The dynamics of the games however must not be altered or confuse the participants in relation to the nature of the game.

## RTP

The prize percentages established in the relevant game rules or as may be defined in the future shall apply (i.e. no set RTP is provided for casino games currently, however our helpfiles must include the RTP).
...
The user may set session time and credit limits for gambling according.
...
- The faces of the cards must clearly show their value.
- The faces of the cards must clearly show the cards’ suit/colour.
- Jokers or wild cards must be distinguished from the rest of the pack.
- The use of more than one deck in the game must be clearly displayed.
...
Incomplete games pop up is required upon reconnection.

In the case of an incomplete game, the particular rules of the game will determine the performance of the platform, which may wait for the participant, cancel the game or continue the game until it is completed.

## Incomplete Games Sweeper

Funds must be returned to the player for any incomplete game that is cancelled by the operator.

There is no specific time period mentioned in the regs for when an imcomplete game shall be cancelled.

The game rules must inform the player on how funds are returned for games incomplete games cancelled by the operator
...
Online gaming activities will be subject to a comprehensive social responsibility policy. Such policy shall combine preventive actions aimed at raising awareness and disseminating good gaming practices, as well as the potential effects of improper practices and their consequences.

Intervention and control shall also be part of such policy.
...
The operator must be closed the player account after 24 months of inactivity.

After the first 12 months of inactivity the account status must be suspended.

The operator must keep a record of these users. The record will include the date and the reason for closure or suspension.
...
For each game, the report will certify the adequacy of the rules implemented by the software with those established by the basic games regulation, including, where appropriate, all possible options, bonus policy, detail of the prizes and game probabilities, as well as the percentage of return to the player.

The RNG must be certified.

In relation to the random number generator, the report will indicate the level of intrinsic quality of the generator, after passing as many statistical tests as necessary to demonstrate that the generated data is random, unpredictable, non-reproducible, and that the escalation and translation is linear and autonomous of any factor other than the generator.
...
Substantial changes must be certified.

Substantial changes require approval from the regulator before going live with that content.

Non-Substantial changes do not require approval from the regulator.
...
| RTP | X |  |
| CARD GAMES | X |  |
| INCOMPLETE GAMES | X | X |
| INCOMPLETE GAMES SWEEPER | X |  |
| INTERGRITY CHECKER ? | X |  |
| AUTOPLAY | X | X |
| PLAYER PROTECTION | X |  |
| RESPONSIBLE GAMING | X |  |
| SESSION INACTIVITY | X |  |
| ACCOUNT SUSPENSION AND CLOSURE | X |  |
| ADVERTISING | X |  |
| CERTIFICATION | X | X |
| CHANGE MANAGEMENT | X | X |
| REPORT AND CONTROL SYSTEM (SAFE?) | X |  |